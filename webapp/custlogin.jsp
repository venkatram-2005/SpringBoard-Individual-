...
.image-container {
            flex: 1;
            background: url('images/141.png') no-repeat center center;
...
<body>
    ...
    <section class="breadcrumb">
        <p>You are here / Customer / Customer Login</p>
    </section>
    ...
    <main>
        ...
        <div class="login-section">
            ...
            <form action="Login" method="post">
                ...
                <a href="registration.jsp" class="forgot-password">Don't have an account?</a>
            </form>
        </div>
